        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-20">
          <div className="text-center">
            ...
            >
              ...
              >
                Brand Elevation Profile reports are available for 7 days. This report is no longer accessible.
              </motion.p>
          ...
          >
            ...
            <div className="space-y-6 text-left">
              <motion.p
                ...
                viewport={{ once: true }}
              >
                Your brand evolves. Your strategy should too. Run a new Brand Elevation Profile to get an updated analysis of your messaging, visual identity, and positioning.
              </motion.p>
              <motion.p
                className="text-xl text-gray-700 leading-relaxed"
                initial={{ opacity: 0, y: 20 }}
